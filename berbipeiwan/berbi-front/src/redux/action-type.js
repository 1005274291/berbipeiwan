...
export const ERROR_MSG="error_msg" //错误提示信息  请求前和请求后
export const RECEIVE_USER="receive_user"  //接收用户信息
export const RESET_USER ="reset_user" //重置用户路由 重新登录
export const RECEIVE_USER_LIST="receive_user_list"//接收用户列表
export const RECEIVE_MSG_LIST="receive_msg_list" //接收所有相关消息列表
export const RECEIVE_MSG="receive_msg"//接收到一条新消息
export const MSG_READ="msg_read" //查看过某个消息